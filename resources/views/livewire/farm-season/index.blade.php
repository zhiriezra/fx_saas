<div class="w-5/6">
    <div class="p-1 lg:p-1 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
        ...
        <h4 class="text-2xl font-bold pl-7">Farm Seasons List <span class="text-lg font-normal">({{ $farm_seasons->count() }})</span> </h4>
    </div>
                    ...
                    <tbody class="">
                        @forelse ($farm_seasons as $key => $farm_season)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    {{ $farm_season->harvest_date? : 'not harvested' }}
                                </td>
